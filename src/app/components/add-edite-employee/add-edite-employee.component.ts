...
export class AddEditeEmployeeComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder, @Inject(MAT_DIALOG_DATA) public data: any, private _empService:EmployeeService,private _dialogRef: MatDialogRef<AddEditeEmployeeComponent>) { }
  empForm!: FormGroup;
  education: string[] = [
    'Matric',
    'Diploma',
